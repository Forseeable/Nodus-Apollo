...
#Region "Properties"
    ...
    Public Property TextColour As Color
        ...
        End Get
        Set(value As Color)
            _TextColour = Color.FromArgb(30, 30, 30)
        End Set
    End Property
    ...
    Public Property HeaderColour As Color
        ...
        End Get
        Set(value As Color)
            _HeaderColour = Color.FromArgb(30, 30, 30)
        End Set
    End Property
    ...
    Public Property MainColour As Color
        ...
        End Get
        Set(value As Color)
            _MainColour = Color.FromArgb(30, 30, 30)
        End Set
    End Property
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With g
            ...
            .FillRectangle(New SolidBrush(Color.FromArgb(30, 30, 30)), New Rectangle(0, 28, Width, 1))
