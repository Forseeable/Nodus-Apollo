...
#Region " Variables"
    Friend G1 As Graphics, B As Bitmap
...
#Region " Dark Colors"
    ...
    Private _HeaderColor As Color = Color.FromArgb(30, 30, 30)
    Private _BaseColor As Color = Color.FromArgb(22, 22, 22)
...
#Region " Light Colors"
    ...
    Public TextLight As Color = Color.FromArgb(30, 30, 30)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        B = New Bitmap(Width, Height) : G1 = Graphics.FromImage(B)
        W = Width : H = Height
...
#Region " Variables"
    ...
    Private State As MouseStateyess = MouseStateyess.None
...
#Region " Mouse States"
    ...
    Protected Overrides Sub OnMouseEnter(e As EventArgs)
        ...
        State = MouseStateyess.Over : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        MyBase.OnMouseDown(e)
        State = MouseStateyess.Down : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseLeave(e As EventArgs)
        MyBase.OnMouseLeave(e)
        State = MouseStateyess.None : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseUp(e As MouseEventArgs)
        MyBase.OnMouseUp(e)
        State = MouseStateyess.Over : Invalidate()
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _TextColor As Color = Color.FromArgb(243, 243, 243)
...
#Region " Colors"
    ...
    Private _Black As Color = Color.FromArgb(30, 30, 30)
...
#Region " Mouse States"
    ...
    Protected Overrides Sub OnMouseUp(e As MouseEventArgs)
        MyBase.OnMouseUp(e)
        State = MouseStateyess.Over : TB.Focus() : Invalidate()
    End Sub
    Protected Overrides Sub OnMouseEnter(e As EventArgs)
        MyBase.OnMouseEnter(e)
        State = MouseStateyess.Over : TB.Focus() : Invalidate()
...
#Region " Colors"
    ...
    Private BGColor As Color = Color.FromArgb(22, 22, 22)
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
        ...
        With G1
            ...
            Select Case K
                ...
                Case _Kind.Error
                    ...
                    Select Case State
                        Case MouseStateyess.Over ' -- Mouse Over
...
#Region " Colors"
    ...
    Private _BGColor As Color = Color.FromArgb(30, 30, 30)
...
#Region " Colors"
    ...
    Private BaseColor As Color = Color.FromArgb(30, 30, 30)
...
#Region " Colors"
        ...
        Private BackColor As Color = Color.FromArgb(30, 30, 30)
...
<DefaultEvent("Scroll")> Class otrflattrackbar : Inherits Control
