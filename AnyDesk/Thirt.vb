...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Select Case ColorScheme
            ...
            Case ColorSchemes.Light
                G.Clear(Color.White)
                G.DrawLine(New Pen(Color.FromArgb(38, 38, 38), 2), New Point(Width - 18, 10), New Point(Width - 14, 14))
                G.DrawLine(New Pen(Color.FromArgb(38, 38, 38), 2), New Point(Width - 14, 14), New Point(Width - 10, 10))
                G.DrawLine(New Pen(Color.FromArgb(38, 38, 38)), New Point(Width - 14, 15), New Point(Width - 14, 14))
        End Select
